...
paths = paths();  
roiName = 'left_OFA';
coordTable = readtable('roi_filtered.xlsx');

customSubjects = {'vp01', 'vp02', 'vp03', 'vp04', 'vp05','vp06','vp08','vp10_YM','vp11_KL','vp12_AJ','vp15_LJ','vp17_LM','vp18_LS'};
...
for s = 1:numel(subjects)
    ...
    rowIdx = strcmp(coordTable.index, subject);
