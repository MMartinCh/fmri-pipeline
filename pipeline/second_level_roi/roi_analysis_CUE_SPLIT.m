...
for s = 1:numel(subjects)
    ...
    %% Find SPM and ROI
    spmName = fullfile(paths.participants, subject, '05_total', 'cue_split','SPM.mat'); 
    ...
    %% Safe outputs
    roiOutFolder = fullfile(paths.roiAnalysis, roiName, 'cue_split');
    ...
    fir_file = fullfile(roiOutFolder, sprintf('%s_%s_fir_CS.txt', subject, roiName));
    fig_file = fullfile(plotFolder, sprintf('%s_%s_fir_CS.png', subject, roiName));
